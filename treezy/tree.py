...
class Tree:
    ...
    def newick(self, **options) -> str:
        ...
        ----------
        **options
            Additional keyword arguments for formatting the Newick string.
    ...
    def from_newick(
        ...
        taxon_names : Optional[list[str]], optional
    ...
    def random(cls, taxon_names: list[str]) -> 'Tree':
        ...
        This creates a random bifurcating tree structure where each internal node
